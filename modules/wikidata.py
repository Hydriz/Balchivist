...
class BALMWikidata(object):
    def __init__(self, argparse=False, params={}, sqldb=None):
        ...
        parameters.
        """
        self.title = "Wikidata entity dumps (JSON and TTL) of all Wikibase "
        self.title += "entries for %s generated on %s"
        self.desc = "These are Wikidata entity dumps (JSON and TTL) of all "
        self.desc += "Wikibase entries for %s that was generated by the "
        self.desc += "Wikimedia Foundation on %s."

...
class BALMWikidata(object):
    ...
    """
    title = "Wikidata entity dumps (JSON and TTL) of all Wikibase entries for "
    title += "%s generated on %s"
    desc = "These are Wikidata entity dumps (JSON and TTL) of all Wikibase "
    desc += "entries for %s that was generated by the Wikimedia Foundation on "
    desc += "%s."
